...
<body class="d-flex h-100 text-center" style="background:white;">
  ...
  <div class="d-flex w-100 h-100 p-5 mx-auto flex-column">
    ...
    <main class="px-3" style=" height: 65vh; display: flex; justify-content: center; align-items: center; ">
      <div class="wrap">
        <div class="main">
          <p style=" font-size: 40px; font-family: 'Varela Round', sans-serif; font-weight: bold; ">주문이 왼료되었습니다.</p>
          	<p style=" font-size: 30px; ">주문번호 : ${orderNum }</p>
          	<p>감사합니다.</p>
          	<a href="/JavaCafe/kiosk" style=" font-size: 24px; ">돌아가기</a>
        </div>
      </div>
    </main>
